...
public class RockPaperScissors {
	...
	public int getPlayerTurn(String input) {
		...
		if(input.equals("p"))return 2;
		if(input.equals("s"))return 3;
		return -1;
	}
	...
	public String getWinner(int playerChoice, int computerChoice) {
		...
		if(playerChoice==3&&computerChoice==1)return COMPUTER;
		if(playerChoice==2&&computerChoice==1)return PLAYER;
		if(playerChoice==1&&computerChoice==2)return COMPUTER;
		if(playerChoice==3&&computerChoice==2)return PLAYER;
		if(playerChoice==2&&computerChoice==3)return COMPUTER;
		return DRAW;
	}
